...
import { Play, Pause, Volume2, VolumeX, Home, ShieldAlert, Shield, Skull, AlertTriangle } from "lucide-react"
...
export default function PlayerPage() {
  ...
  const [tokenStatus, setTokenStatus] = useState<"valid" | "checking" | "invalidated">("valid")
    ...
    <div className="flex flex-col items-center justify-center gap-6 max-w-4xl mx-auto">
      <div className="w-full">
        <div className="flex items-center justify-between mb-4">
          <Badge variant={userType === "legitimate" ? "outline" : "destructive"} className="text-sm py-1.5">
            {userType === "legitimate" ? (
          ...
          <div className="flex gap-2">
            ...
            <Badge
              variant={tokenStatus === "valid" ? "outline" : tokenStatus === "checking" ? "secondary" : "destructive"}
            >
              Token: {tokenStatus === "valid" ? "Valid" : tokenStatus === "checking" ? "Checking..." : "Invalidated"}
            </Badge>
          </div>
        </div>
          ...
          <div className="relative aspect-video bg-black">
            {showPirateWarning && (
              <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/90 z-10 p-6 text-center">
                ...
                <h3 className="text-xl font-bold text-destructive mb-2">Token Invalidated</h3>
                <p className="text-muted-foreground mb-4">
                  Unauthorized streaming detected. Your token has been invalidated due to suspicious activity.
                </p>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  <Button variant="ghost" size="icon" onClick={togglePlay} disabled={tokenStatus === "invalidated"}>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Button variant="outline" size="sm" onClick={() => router.push("/management")}>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <div className="flex justify-between">
                ...
                <span className="text-sm font-medium">{tokenStatus === "invalidated" ? "0%" : "98%"}</span>
              </div>
              <Progress value={tokenStatus === "invalidated" ? 0 : 98} className="h-2" />
            </div>
            ...
            <div className="space-y-2">
              <div className="flex justify-between">
                ...
                <span className="text-sm font-medium">
                  {tokenStatus === "valid" ? "Valid" : tokenStatus === "checking" ? "Checking..." : "Invalid"}
                </span>
              </div>
              <Progress
                value={tokenStatus === "valid" ? 100 : tokenStatus === "checking" ? 50 : 0}
                className={`h-2 ${
                  tokenStatus === "valid" ? "" : tokenStatus === "checking" ? "bg-amber-500" : "bg-destructive"
                }`}
              />
            </div>
          </div>
